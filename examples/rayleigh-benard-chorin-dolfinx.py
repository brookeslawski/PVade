...
h = 0.05
nx = 100 # 50  # 150 # int((x_max - x_min)/h)
ny = 30 # 10 # 50  # 50 # int((y_max - y_min)/h)
...
n = Constant(mesh, PETSc.ScalarType((0, 1)))
...
F1 -= Ra * inner(theta_n * n, v) * dx
# F1 -= Ra * inner(theta_n, v) * dx
